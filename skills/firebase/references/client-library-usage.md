...
The Firebase client-side SDKs allow direct interaction with Firebase services from a
mobile or web app. These SDKs are available for iOS (Swift and Objective-C),
Android (Kotlin and Java), Web (JavaScript), Flutter (Dart), Unity, and C++.


- For **web apps**, Agent Skills for Firebase provide guides to get started
 with the JavaScript client SDK. Install them by running:
...
- For **native iOS or Android mobile apps**, see the documentation to get started:
...
https://firebase.google.com/docs/reference/admin and
